...
var BlogView = _backbone2.default.View.extend({
	...
	initialize: function initialize() {
		...
		this.template = _underscore2.default.template($('.blog-list-template').html());
	},
	events: {
...
var BlogsView = _backbone2.default.View.extend({
	...
	render: function render() {
		...
		this.$el.html('');
		this.model.toArray().forEach(function (blog) {
			_this.$el.append(new BlogView({ model: blog }).render().$el);
		});
		return this;
	}
});
